...
::Star_obj::__register();
::WeatherParticle_obj::__register();
...
::DragonHead_obj::__register();
::DragonBody_obj::__register();
...
::DragonBody_obj::__boot();
::DragonHead_obj::__boot();
