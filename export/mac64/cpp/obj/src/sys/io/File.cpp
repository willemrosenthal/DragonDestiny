...
::String File_obj::getContent( ::String path){
	HX_STACK_PUSH("File::getContent","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",27);
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_PUSH("File::getBytes","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",32);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(33)
...
bool binary = __o_binary.Default(true);
	HX_STACK_PUSH("File::write","/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",53);
	HX_STACK_ARG(path,"path");
