...
{
		HX_STACK_PUSH("FlxSystemButton::destroy","flixel/system/ui/FlxSystemButton.hx",118);
		HX_STACK_THIS(this);
		HX_STACK_LINE(119)
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseOut","flixel/system/ui/FlxSystemButton.hx",113);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(114)
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseOver","flixel/system/ui/FlxSystemButton.hx",108);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(109)
		::flixel::system::ui::FlxSystemButton _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_PUSH("FlxSystemButton::onMouseUp","flixel/system/ui/FlxSystemButton.hx",99);
		HX_STACK_THIS(this);
		HX_STACK_ARG(E,"E");
		HX_STACK_LINE(99)
...
{
		HX_STACK_PUSH("FlxSystemButton::changeIcon","flixel/system/ui/FlxSystemButton.hx",88);
		HX_STACK_THIS(this);
