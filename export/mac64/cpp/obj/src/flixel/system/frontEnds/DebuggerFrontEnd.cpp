...
bool UpdateLayout = __o_UpdateLayout.Default(true);
	HX_STACK_PUSH("DebuggerFrontEnd::removeButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",102);
	HX_STACK_THIS(this);
...
bool UpdateLayout = __o_UpdateLayout.Default(true);
	HX_STACK_PUSH("DebuggerFrontEnd::addButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",88);
	HX_STACK_THIS(this);
...
bool DebuggerFrontEnd_obj::set_visible( bool Visible){
	HX_STACK_PUSH("DebuggerFrontEnd::set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",71);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DebuggerFrontEnd::resetLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",58);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("DebuggerFrontEnd::setLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",48);
		HX_STACK_THIS(this);
