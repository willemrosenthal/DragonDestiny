...
{
HX_STACK_PUSH("FlxPoint::new","flixel/util/FlxPoint.hx",9);
...
::String FlxPoint_obj::toString( ){
	HX_STACK_PUSH("FlxPoint::toString","flixel/util/FlxPoint.hx",148);
	HX_STACK_THIS(this);
	HX_STACK_LINE(149)
...
{
		HX_STACK_PUSH("FlxPoint::destroy","flixel/util/FlxPoint.hx",142);
		HX_STACK_THIS(this);
	}
return null();
}
...
Float FlxPoint_obj::distanceTo( ::flixel::util::FlxPoint AnotherPoint){
	HX_STACK_PUSH("FlxPoint::distanceTo","flixel/util/FlxPoint.hx",138);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static Float Block( ::flixel::util::FlxPoint_obj *__this,::flixel::util::FlxPoint &AnotherPoint){
			HX_STACK_PUSH("*::closure","flixel/util/FlxPoint.hx",139);
			{
				HX_STACK_LINE(139)
...
bool FlxPoint_obj::inFlxRect( ::flixel::util::FlxRect Rect){
	HX_STACK_PUSH("FlxPoint::inFlxRect","flixel/util/FlxPoint.hx",127);
	HX_STACK_THIS(this);
...
bool FlxPoint_obj::inCoords( Float RectX,Float RectY,Float RectWidth,Float RectHeight){
	HX_STACK_PUSH("FlxPoint::inCoords","flixel/util/FlxPoint.hx",116);
	HX_STACK_THIS(this);
...
::flash::geom::Point FlxPoint_obj::copyToFlash( ::flash::geom::Point FlashPoint){
	HX_STACK_PUSH("FlxPoint::copyToFlash","flixel/util/FlxPoint.hx",100);
	HX_STACK_THIS(this);
...
::flixel::util::FlxPoint FlxPoint_obj::copyFromFlash( ::flash::geom::Point FlashPoint){
	HX_STACK_PUSH("FlxPoint::copyFromFlash","flixel/util/FlxPoint.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_ARG(FlashPoint,"FlashPoint");
	HX_STACK_LINE(89)
...
::flixel::util::FlxPoint FlxPoint_obj::copyTo( ::flixel::util::FlxPoint point){
	HX_STACK_PUSH("FlxPoint::copyTo","flixel/util/FlxPoint.hx",72);
	HX_STACK_THIS(this);
...
::flixel::util::FlxPoint FlxPoint_obj::copyFrom( ::flixel::util::FlxPoint point){
	HX_STACK_PUSH("FlxPoint::copyFrom","flixel/util/FlxPoint.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(61)
	this->set_x(point->x);
...
Float X = __o_X.Default(0);
Float Y = __o_Y.Default(0);
	HX_STACK_PUSH("FlxPoint::set","flixel/util/FlxPoint.hx",48);
	HX_STACK_THIS(this);
	HX_STACK_ARG(X,"X");
	HX_STACK_ARG(Y,"Y");
{
...
Float FlxPoint_obj::set_y( Float Value){
	HX_STACK_PUSH("FlxPoint::set_y","flixel/util/FlxPoint.hx",27);
	HX_STACK_THIS(this);
...
Float FlxPoint_obj::set_x( Float Value){
	HX_STACK_PUSH("FlxPoint::set_x","flixel/util/FlxPoint.hx",17);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Value,"Value");
	HX_STACK_LINE(17)
	return this->x = Value;
