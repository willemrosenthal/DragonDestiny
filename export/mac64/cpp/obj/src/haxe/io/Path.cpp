...
{
HX_STACK_PUSH("Path::new","/usr/lib/haxe/std/haxe/io/Path.hx",75);
{
	HX_STACK_LINE(76)
...
::String Path_obj::directory( ::String path){
	HX_STACK_PUSH("Path::directory","/usr/lib/haxe/std/haxe/io/Path.hx",140);
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_PUSH("Path::addTrailingSlash","/usr/lib/haxe/std/haxe/io/Path.hx",186);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(187)
	...
	struct _Function_1_1{
		inline static ::String Block( int &c2,::String &path){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/io/Path.hx",191);
			{
				HX_STACK_LINE(191)
